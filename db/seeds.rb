...
demand2 = Demand.create(proposed_price: 10.00, client_id: user2.id, product_id: product2.id, comment: "Hello, i'm interested by this product")
demand3 = Demand.create(proposed_price: 9.99, client_id: user2.id, product_id: product3.id, comment: "Someone to make me this ?")
demand4 = Demand.create(proposed_price: 2.00, client_id: user4.id, product_id: product4.id, comment: "oh too smart i want it pls")
demand5 = Demand.create(proposed_price: 23.00, client_id: user6.id, product_id: product5.id, comment: "Yo Can someone print this for me pls ?")
demand6 = Demand.create(proposed_price: 11.00, client_id: user6.id, product_id: product6.id, comment: "Ahah What a good idea")
demand7 = Demand.create(proposed_price: 11.00, client_id: user6.id, product_id: product7.id, comment: "Finally i will stop losing my sponge ^^")
demand8 = Demand.create(proposed_price: 12.00, client_id: user8.id, product_id: product8.id, comment: "hello")
demand9 = Demand.create(proposed_price: 18.00, client_id: user8.id, product_id: product9.id, comment: "No comment")
demand10 = Demand.create(proposed_price: 10.00, client_id: user8.id, product_id: product0.id, comment: "want this !!!")
demand11 = Demand.create(proposed_price: 8.00, client_id: user9.id, product_id: product11.id, comment: "yeah i needed smth like that in my desk :)")
demand12 = Demand.create(proposed_price: 15.50, client_id: user10.id, product_id: product12.id, comment: "perfect and cheap, need this")
demand13 = Demand.create(proposed_price: 17.00, client_id: user13.id, product_id: product13.id, comment: "17$ i need it quickly pls")
demand14 = Demand.create(proposed_price: 13.00, client_id: user13.id, product_id: product14.id, comment: "so beautiful i want it")
demand15 = Demand.create(proposed_price: 31.00, client_id: user13.id, product_id: product15.id, comment: "i need the plastic bloc pls")
demand16 = Demand.create(proposed_price: 13.50, client_id: user13.id, product_id: product16.id, comment: "I need a new valve, print me pls")
demand17 = Demand.create(proposed_price: 16.00, client_id: user13.id, product_id: product17.id, comment: "hello i need this cd-rom pump in black if possible pls")
demand18 = Demand.create(proposed_price: 26.00, client_id: user13.id, product_id: product18.id, comment: "dont want to buy a new one, i want to fix it")
demand19 = Demand.create(proposed_price: 27.00, client_id: user13.id, product_id: product19.id, comment: "someone to print this for my kids pls")
demand20 = Demand.create(proposed_price: 29.00, client_id: user13.id, product_id: product20.id, comment: "Can someone help me have it")
demand21 = Demand.create(proposed_price: 21.00, client_id: user13.id, product_id: product21.id, comment: "oh i want this dispenser pls print me ?")
demand22 = Demand.create(proposed_price: 26.00, client_id: user19.id, product_id: product1.id, comment: "too sweet, want it so bad")
demand23 = Demand.create(proposed_price: 22.00, client_id: user19.id, product_id: product2.id, comment: "Hello i'm interested")
demand24 = Demand.create(proposed_price: 23.00, client_id: user19.id, product_id: product3.id, comment: "Wow it looks cool, print it to me pls")
demand25 = Demand.create(proposed_price: 8.00, client_id: user12.id, product_id: product4.id, comment: "No comment")
demand26 = Demand.create(proposed_price: 7.30, client_id: user12.id, product_id: product5.id, comment: "looks good to me")
demand27 = Demand.create(proposed_price: 5.20, client_id: user16.id, product_id: product7.id, comment: "I want it before november if possible")
demand28 = Demand.create(proposed_price: 11.00, client_id: user16.id, product_id: product8.id, comment: "I need it by someone near me if possible")
demand29 = Demand.create(proposed_price: 9.50, client_id: user16.id, product_id: product9.id, comment: "That's a cool item, can someone print it for me")
demand30 = Demand.create(proposed_price: 8.99, client_id: user11.id, product_id: product0.id, comment: "No comment")
demand31 = Demand.create(proposed_price: 12.70, client_id: user11.id, product_id: product11.id, comment: "Ahah I need it")
demand32 = Demand.create(proposed_price: 17.70, client_id: user14.id, product_id: product12.id, comment: "Just take my money")
demand33 = Demand.create(proposed_price: 6.30, client_id: user17.id, product_id: product13.id, comment: "Best item for bad cookers")
demand34 = Demand.create(proposed_price: 8.00, client_id: user21.id, product_id: product14.id, comment: "Hello, i would like to have it pls print it to me")
demand35 = Demand.create(proposed_price: 8.60, client_id: user14.id, product_id: product15.id, comment: "Ahah already got me, gonna give it to my mom")
demand36 = Demand.create(proposed_price: 23.20, client_id: user14.id, product_id: product16.id, comment: "Looks fun")
demand37 = Demand.create(proposed_price: 21.50, client_id: user14.id, product_id: product17.id, comment: "i need to repair my aquarium pump")
demand38 = Demand.create(proposed_price: 23.00, client_id: user15.id, product_id: product18.id, comment: "that's awesome, someone to print it ?")
demand39 = Demand.create(proposed_price: 14.60, client_id: user15.id, product_id: product19.id, comment: "I want it xD")
demand40 = Demand.create(proposed_price: 18.90, client_id: user18.id, product_id: product20.id, comment: "Can you print it in black pls ?")
demand41 = Demand.create(proposed_price: 31.00, client_id: user18.id, product_id: product21.id, comment: "I'm a newbie fisherman but i want to try the solidness of the fishing rod")
demand42 = Demand.create(proposed_price: 33.90, client_id: user20.id, product_id: product1.id, comment: "Can someone print it in pink, it's a gift")
demand43 = Demand.create(proposed_price: 15.60, client_id: user20.id, product_id: product2.id, comment: "gonna give it to my dad")
demand44 = Demand.create(proposed_price: 19.00, client_id: user17.id, product_id: product3.id, comment: "So cool")
demand45 = Demand.create(proposed_price: 26.30, client_id: user21.id, product_id: product4.id, comment: "No comment")
demand46 = Demand.create(proposed_price: 28.70, client_id: user12.id, product_id: product5.id, comment: "What a good idea, want it pls")
demand47 = Demand.create(proposed_price: 34.50, client_id: user18.id, product_id: product6.id, comment: "Hello i would like it in green pls")
...
product21.photo.attach(io: file21, filename: 'card_preview_20190808', content_type: 'image/jpg')
