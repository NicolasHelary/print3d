...
puts "Creating Users..."
user1 = User.new(first_name: "Nico", email: "nico@leaddev.fr", address: "105 Rue des gnomes", last_name: "one", printer: true, password: "azerty")
user2 = User.new(first_name: "Tojo", email: "tojo@dev.fr", address: "105 Rue du git status", last_name: "two", printer: false, password: "azerty")
user3 = User.new(first_name: "Romu", email: "romualdo@dev.fr", address: "105 Rue de la navbar", last_name: "three", printer: true, password: "azerty")
user4 = User.new(first_name: "Bry", email: "bry@dev.fr", address: "105 Rue des seeds", last_name: "four", printer: false, password: "azerty")
user5 = User.new(first_name: "Jean Loup", email: "Jeanloup@TAdev.fr", address: "105 Rue des tickets", last_name: "five", printer: false, password: "azerty")
puts "Users created !"

puts "creating products..."
product1 = Product.new(name: "Can opener",
                    description: "open cans easily",
                    file3d: "https://cdn.thingiverse.com/assets/6b/8c/69/44/3a/CanLidOpenerLid.stl")
product2 = Product.new(name: "Beer Crate",
                    description: "to store your beers",
                    file3d: "https://cdn.thingiverse.com/assets/e1/78/13/5d/2d/beer_crate_18650.stl")
product3 = Product.new(name: "Disk Rack Roller",
                    description: "replacement of upper disk",
                    file3d: "https://cdn.thingiverse.com/assets/90/8c/78/6d/5b/roller_pulley.stl")
product4 = Product.new(name: "Air ventilation valve",
                    description: "replacement of upper disk",
                    file3d: "https://cdn.thingiverse.com/assets/3b/ac/61/a5/bd/Klapan_1.stl")
product5 = Product.new(name: "Ice dragon",
                    description: "to store your beers",
                    file3d: "https://cdn.thingiverse.com/assets/b0/e3/13/54/87/ARTICULATED_ice_dragon_fixed_p1.stl")
product6 = Product.new(name: "T-Rex",
                    description: "replacement of upper disk",
                    file3d: "https://cdn.thingiverse.com/assets/4d/6e/1d/fc/35/103_Assembly_T-Rex_v7.stl")
product7 = Product.new(name: "Homer sponge holder",
                    description: "replacement of upper disk",
                    file3d: "https://cdn.thingiverse.com/assets/57/13/25/ec/71/Sponge_holder.stl")
product8 = Product.new(name: "Pocket catapult",
                    description: "to store your beers",
                    file3d: "https://cdn.thingiverse.com/assets/fa/1b/a2/b7/b1/Full_set_Catapult.stl")
product9 = Product.new(name: "Reel Holder",
                    description: "replacement of upper disk",
                    file3d: "https://cdn.thingiverse.com/assets/c8/05/ff/16/6c/Frame.stl")
product10 = Product.new(name: "Plug cover",
                    description: "replacement of upper disk",
...
offer1 = Offer.new(price: 15.00, status: 1, client_score: 5, printer_score: 5, demand_id: demand1.id, printer_id: user1.id)
offer2 = Offer.new(price: 15.00, status: 1, client_score: 5, printer_score: 5, demand_id: demand1.id, printer_id: user1.id)
offer3 = Offer.new(price: 15.00, status: 1, client_score: 5, printer_score: 5, demand_id: demand1.id, printer_id: user3.id)
offer4 = Offer.new(price: 15.00, status: 1, client_score: 5, printer_score: 5, demand_id: demand1.id, printer_id: user3.id)
offer5 = Offer.new(price: 15.00, status: 1, client_score: 5, printer_score: 5, demand_id: demand1.id, printer_id: user1.id)
puts "Offers Created !"
