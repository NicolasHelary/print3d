...
demand7 = Demand.create(proposed_price: 11.00, client_id: user6.id, product_id: product7.id, comment: "Finally i will stop losing my batteries")
...
demand11 = Demand.create(proposed_price: 8.00, client_id: user9.id, product_id: product11.id, comment: "i broke my disc rack help me :)")
demand12 = Demand.create(proposed_price: 15.50, client_id: user10.id, product_id: product12.id, comment: "I need to repair my rollers")
demand13 = Demand.create(proposed_price: 17.00, client_id: user13.id, product_id: product13.id, comment: "17$ i need it quickly pls")
demand14 = Demand.create(proposed_price: 13.00, client_id: user13.id, product_id: product14.id, comment: "already got the roller need the plastic disk pls")
demand15 = Demand.create(proposed_price: 31.00, client_id: user13.id, product_id: product15.id, comment: "May someone print me the disk pls")
...
demand17 = Demand.create(proposed_price: 16.00, client_id: user13.id, product_id: product17.id, comment: "hello i need this air ventilation valve pls")
demand18 = Demand.create(proposed_price: 26.00, client_id: user13.id, product_id: product18.id, comment: "dont want to buy a new air conditionning, i want to fix it")
demand19 = Demand.create(proposed_price: 27.00, client_id: user13.id, product_id: product19.id, comment: "No comment")
...
demand21 = Demand.create(proposed_price: 21.00, client_id: user13.id, product_id: product21.id, comment: "Is this a real dragon ?")
demand22 = Demand.create(proposed_price: 26.00, client_id: user19.id, product_id: product1.id, comment: "too sweet, want it so bad")
demand23 = Demand.create(proposed_price: 22.00, client_id: user19.id, product_id: product2.id, comment: "Hello i'm interested by this ice dragon")
...
demand29 = Demand.create(proposed_price: 9.50, client_id: user16.id, product_id: product9.id, comment: "That's a cool trex, can someone print it for me")
...
demand33 = Demand.create(proposed_price: 6.30, client_id: user17.id, product_id: product13.id, comment: "Best sponge holder")
...
demand37 = Demand.create(proposed_price: 21.50, client_id: user14.id, product_id: product17.id, comment: "want to try it with my kids ^^")
