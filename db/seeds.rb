...
demand2 = Demand.create(proposed_price: 10.00, client_id: user2.id, product_id: product21.id, comment: "Hello, i'm interested by this product")
demand3 = Demand.create(proposed_price: 9.99, client_id: user2.id, product_id: product21.id, comment: "Someone to make me this ?")
...
demand6 = Demand.create(proposed_price: 11.00, client_id: user6.id, product_id: product20.id, comment: "Ahah What a good idea")
...
demand8 = Demand.create(proposed_price: 12.00, client_id: user8.id, product_id: product18.id, comment: "hello")
demand9 = Demand.create(proposed_price: 18.00, client_id: user8.id, product_id: product2.id, comment: "No comment")
demand10 = Demand.create(proposed_price: 10.00, client_id: user8.id, product_id: product17.id, comment: "want this !!!")
...
demand17 = Demand.create(proposed_price: 16.00, client_id: user13.id, product_id: product21.id, comment: "hello i need this air ventilation valve pls")
...
demand24 = Demand.create(proposed_price: 23.00, client_id: user19.id, product_id: product11.id, comment: "Wow it looks cool, print it to me pls")
...
demand28 = Demand.create(proposed_price: 11.00, client_id: user16.id, product_id: product12.id, comment: "I need it by someone near me if possible")
...
demand31 = Demand.create(proposed_price: 12.70, client_id: user11.id, product_id: product13.id, comment: "Ahah I need it")
demand32 = Demand.create(proposed_price: 17.70, client_id: user14.id, product_id: product13.id, comment: "Just take my money")
...
demand35 = Demand.create(proposed_price: 8.60, client_id: user14.id, product_id: product14.id, comment: "Ahah already got me, gonna give it to my mom")
demand36 = Demand.create(proposed_price: 23.20, client_id: user14.id, product_id: product15.id, comment: "Looks fun")
...
demand39 = Demand.create(proposed_price: 14.60, client_id: user15.id, product_id: product15.id, comment: "I want it xD")
...
demand41 = Demand.create(proposed_price: 31.00, client_id: user18.id, product_id: product16.id, comment: "I'm a newbie fisherman but i want to try the solidness of the fishing rod")
...
demand43 = Demand.create(proposed_price: 15.60, client_id: user20.id, product_id: product16.id, comment: "gonna give it to my dad")
demand44 = Demand.create(proposed_price: 19.00, client_id: user17.id, product_id: product9.id, comment: "So cool")
demand45 = Demand.create(proposed_price: 26.30, client_id: user21.id, product_id: product17.id, comment: "No comment")
...
demand48 = Demand.create(proposed_price: 16.00, client_id: user6.id, product_id: product18.id, comment: "want this !!!")
demand49 = Demand.create(proposed_price: 13.00, client_id: user10.id, product_id: product19.id, comment: "I need it in white pls")
demand50 = Demand.create(proposed_price: 12.00, client_id: user10.id, product_id: product20.id, comment: "No comment")
